...
import './four.css'
import profile from '../../../../Assets/KALASANGAM.png';

export function SectionFour() { 

  const imageUrls = [
    'https://images.unsplash.com/photo-1568805778719-c768512debe8?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'https://images.unsplash.com/photo-1563837738662-c86ef2ba99f8?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'https://images.unsplash.com/photo-1606681246653-74521ac452f4?q=80&w=2778&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'https://images.unsplash.com/photo-1599302994569-6fd86e9529e2?q=80&w=2864&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'https://images.unsplash.com/photo-1524314010015-136ee8ae1ab3?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'https://images.unsplash.com/photo-1616089180418-56172f6c3c2b?q=80&w=2874&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  ];
  ...
  return (
    <div className='sectionfour'>
      ...
      <div className="sectionfour_container">
        <aside className="sectionfour_carousel">
          <div className="sectionfour_carousel__wrapper">
            {duplicatedImages.map((url, index) => (
              <div className="item" key={`slide-${index}`} id={`slide-${index}`}>
                <img src={url} 
                alt={`Slide ${index + 1}`} 
                width="418" 
                height="418" />
      ...
      <article className="sectionFour">
        <header className="sectionFour__header">
          <figure>
            <img src={profile} width="42" height="42" />
            <figcaption>
              <h4>KalaSangam</h4>
            </figcaption>
          </figure>
        </header>
        <section className="sectionFour__media">
          <div className="img"></div>
        </section>
        <footer className="sectionFour__buttons">
          <div className="left">
            <svg className="sectionFour__icon sectionFour__icon--heart" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <svg className="sectionFour__icon sectionFour__icon--comment" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <svg className="sectionFour__icon sectionFour__icon--message" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path d="M22 3 9.218 10.083M11.698 20.334 22 3.001H2L9.218 10.084 11.698 20.334Z" />
            </svg>
          </div>
          <div className="right">
            <svg className="sectionFour__icon sectionFour__icon--saved" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
